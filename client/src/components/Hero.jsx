...
const Hero = () => {
  ...
  return (
    <div className='container 2xl:px-20 mx-auto my-10 px-4'>
        <div className='bg-linear-to-r from-purple-800 to-purple-950 text-white py-16 text-center mx-2 rounded-xl px-6 md:px-16 lg:px-24'>
        ...
        <div className='border border-gray-300 shadow-md mx-2 mt-5 p-6 rounded-md flex justify-center items-center'>
            <div className='flex justify-center items-center gap-6 sm:gap-10 lg:gap-16 flex-wrap w-full' >
                ...
                <img className='h-5 sm:h-6 max-w-20 sm:max-w-none object-contain ' src={assets.microsoft_logo} alt=''/>
                <img className='h-5 sm:h-6 max-w-20 sm:max-w-none object-contain' src={assets.walmart_logo} alt=''/>
                <img className='h-5 sm:h-6 max-w-20 sm:max-w-none object-contain' src={assets.accenture_logo} alt=''/>
                <img className='h-5 sm:h-6 max-w-20 sm:max-w-none object-contain' src={assets.samsung_logo} alt=''/>
                <img className='h-5 sm:h-6 max-w-20 sm:max-w-none object-contain' src={assets.amazon_logo} alt=''/>
                <img className='h-5 sm:h-6 max-w-20 sm:max-w-none object-contain' src={assets.adobe_logo} alt=''/>
            </div>
        </div>
